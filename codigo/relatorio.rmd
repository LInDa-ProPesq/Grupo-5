...
Além dos benefícios acima citados, 58,8% dos entrevistados acreditam que o uso das mídias sociais podem melhorar os resultados dos discentes, contra uma rejeição de apenas 14,7%. 26,5% dos entrevistados não sabem ou não puderam opinar sobre o assunto. O próximo gráfico ilustra os dados.
...
Analisando o gráfico acima, podemos perceber que as pessoas que utilizam as redes sociais para compartilhamento de fotos e vídeos são as que mais acreditam que as mídias sociais são a melhor forma de aproximar os professores dos alunos.
...
Abaixo podemos ver as redes sociais mais utilizadas pela amostra, onde aqueles professores interessados em utilizar uma rede social como ferramenta, poderiam tentar uma aproximação ou atividada que envolvesse as mesmas.
...
### Conclusão
Portanto, muitas instituições estão começando a utilizar as redes sociais para auxiliar no ensino e tentar uma melhora no rendimento dos alunos. Os alunos acham que esta é uma técnica interessante e que pode melhorar o aproveitamento em sala de aula, com melhora do aprendizado, praticidade, fácilidade no acesso às informações, entre outras características. Ainda assim, muitos professores ainda tem preconceito com a utilização das ferramentas citadas acima, pois ainda é muito complicado de se controlar, em sala de aula, o que os alunos estão fazendo em seus celulares ou computadores. Além disso, é sempre bom lembrar que por mais que as Redes ou Mídias Sociais possam auxiliar no aprendizado, as mesmas não substituem um professor de verdade, e sem o auxílio do mesmo, qualquer técnica de introdução destas ferramentas no processo ensino se torna inútil.
