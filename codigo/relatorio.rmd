...
```
>>>>>>> 3a761cc4404fce8054bc7c16ed6ff5366729b71a
...
Além dos benefícios acima citados, 58,8% dos entrevistados acreditam que o uso das mídias sociais podem melhorar os resultados dos discentes, contra uma rejeição de apenas 14,7%. 26,5% dos entrevistados não sabem ou não puderam opinar sobre o assunto. O gráfico 6 ilustra os dados.

## [GRÁFICO QUESTÃO 6 - QUANTIDADE X RESPOSTA]
...
Analisando o gráfico acima, podemos perceber que quanto mais tempo um aluno passa nas redes sociais, maior é a tendência de ele acreditar que o uso das mídias sociais integradas ao ensino pode melhorar o resultado dos alunos.
...
http://educacaopublica.cederj.edu.br/revista/artigos/as-redes-sociais-como-ferramentas-didaticas-virtuais-de-interacao-e-ensino
