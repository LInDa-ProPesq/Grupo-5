...
```{r echo=FALSE, fig.width=11}
barplot(pd$X__1, main = "Principais dificuldades de uso de Mídias Sociais em um ambiente educacional", names.arg = pd$`Principais Dificuldades`, ylim = c(0, 70), col=c("blue","purple", "green3", "aquamarine", "chocolate1", "chartreuse1"))
```
...
```{r echo=FALSE, fig.width=11}
barplot(sm$Usuarios, main = "Numero de usuários por Rede Social", names.arg = sm$`Rede Social`, ylim = c(0, 70), col=c("blue","purple", "green3", "aquamarine", "chocolate1", "chartreuse1", "cyan4", "darkgoldenrod1", "coral2", "deeppink1"))
```
